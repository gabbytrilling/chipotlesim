...
class TestChipotleSim(unittest.TestCase):
    ...
    def test_calories_count(self):
        self.assertEqual(order1.calories_count, 525)
        self.assertEqual(order2.calories_count, 725)
        self.assertEqual(order3.calories_count, 850)
        self.assertEqual(order4.calories_count, 755)
